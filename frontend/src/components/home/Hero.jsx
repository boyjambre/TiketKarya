...
/>
        ...
        />
          <button className="fixed bottom-10 right-50 z-50 flex items-center gap-2 rounded-full bg-[#FF5126] px-6 py-3 text-sm font-semibold text-white shadow-md hover:bg-[#ff693f]">
          <Headphones size={18} />
          Customer Support
        </button>
        </div>
