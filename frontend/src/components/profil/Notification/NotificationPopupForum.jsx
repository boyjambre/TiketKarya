...
const NotificationPopupForum = ({ onClose }) => {
  ...
  return (
    ...
    >
      <div className="w-150 h-140 bg-[#FCEDDA] mt-6 shadow-lg p-6 animate-slide-in">
        {/* Header */}
        ...
        <div className="text-md ml-18 mr-12 text-[#000000] space-y-6">
          ...
          <div className="text-center">
            <button className="bg-[#2B2B2B] text-white px-8 py-[10px] rounded-sm font-semibold hover:bg-[#FFDEB5] hover:text-[#2B2B2B] transition-colors duration-300">
              View Replies
            </button>
          </div>
        </div>
