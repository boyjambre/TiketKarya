    ...
    <div className="max-w-4xl ml-0 px-[-10px] py-2 text-sm">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
        ...
        <div className="md:col-span-2 mt-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <button className="bg-[#FF5126] text-white px-3 py-1 rounded text-sm">Change</button>
            {profileImage && (
      ...
      <div className="mt-10 flex items-center w-full">
        ...
        <div className="flex gap-6 ml-auto">
          <button className="bg-[#FFDEB5] text-black px-6 py-2 text-sm">Cancel</button>
          <button
            onClick={handleUpdate}
            className="bg-[#FF5126] text-white px-6 py-2 text-sm"
          >
            Update
          </button>
        </div>
